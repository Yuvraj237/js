										...
										<div class="card-body border-top p-9">
											...
											<div class="d-flex flex-wrap align-items-center">
												...
												<div id="kt_signin_email">
													...
													<div class="fw-semibold text-gray-600">support@keenthemes.com
													</div>
												</div>
												<!--end::Label-->
												<!--begin::Edit-->
														...
														<div class="row mb-6">
															<div class="col-lg-6 mb-4 mb-lg-0">
																<div class="fv-row mb-0">
																	...
																	<input type="email" class="form-control form-control-lg form-control-solid" id="emailaddress" placeholder="Email Address" name="emailaddress" value="support@demo.com" />
																</div>
															</div>
															<div class="col-lg-6">
																<div class="fv-row mb-0">
